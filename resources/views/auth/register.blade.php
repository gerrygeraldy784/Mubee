            ...
            <form method="POST" action="{{ route('register') }}">
                ...
                <div class="form-group">
                    ...
                    <div class="input-wrapper">
                        ...
                        <input class="form-input" type="text" id="name" name="name" value="{{ old('name') }}" placeholder="masukkan nama lengkap Anda" required autofocus>
                    </div>
                    @error('name')
                ...
                <div class="form-group">
                    ...
                    <div class="input-wrapper">
                        ...
                        <input class="form-input" type="email" id="email" name="email" value="{{ old('email') }}" placeholder="masukkan email Anda" required>
                    </div>
                    @error('email')
                        <div class="error-message">
                            <i class="fa-solid fa-triangle-exclamation"></i> {{ $message }}
                ...
                <div class="form-group">
                    ...
                    <div class="input-wrapper">
                        ...
                        <input class="form-input" type="password" id="password_confirmation" name="password_confirmation" placeholder="ulangi password Anda" required>
                    </div>
                </div>
