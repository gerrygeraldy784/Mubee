...
<head>
    ...
    <title>Lupa Password - Mubee</title>
...
<body>
    ...
    <main>
        <div class="login-card">
            ...
            <p class="login-subtitle">Masukkan email terdaftar Anda untuk melanjutkan ke pembaruan password.</p>
            ...
            <form method="POST" action="{{ route('password.email') }}">
                ...
                <button type="submit" class="btn-submit">
                    Verifikasi Email <i class="fa-solid fa-arrow-right"></i>
                </button>
            </form>
